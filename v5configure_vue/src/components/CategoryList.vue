...
export default {
  ...
  methods: {
    ...
    handleClick(index, type) {
      ...
      switch (type) {
        case 0:  //查看
          ...
          var detailinfo = _this.categorys[index];
        ...
        case 1:  // 编辑
          ...
          _this.dialogFormVisible = true
          _this.inputEnable = type == 0
          var editinfo = _this.categorys[index];
        ...
        case 3:  //删除
          ...
          this.delete(_this.categorys[index])
          break;
      }
    ...
    delete(info) {
      ...
      this.$axios
          .delete('/removecategory/' + info.id).then(resp => {
        if (resp && resp.data.code === 200) {
          this.queryall()
        }
      })
